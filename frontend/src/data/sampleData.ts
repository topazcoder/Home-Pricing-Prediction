import { AnalyzeHomeRequest } from '../types';

export const sampleData: AnalyzeHomeRequest = {
  subject_home: {
  ...
  video_transcript: `Welcome to 123 Main Street. This beautiful home features 4 bedrooms and 3 bathrooms.
